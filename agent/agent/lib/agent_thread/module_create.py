...
class ModuleCreate(DownloadHelper):
    ...
    def __init__(self, threadMgr, module, package, parentId = None):
        """ Constructor """
        DownloadHelper.__init__(self, threadMgr, cat = ['Module/%s' % module], name = 'create_module', parentId = parentId)
    ...
    def _getBuiltThread(self, scriptName):
        ...
        execPath = os.path.join(manifestutil.modulePath(self.__service, self.__module), 
